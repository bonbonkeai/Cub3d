...
/*   Updated: 2025/08/30 14:30:09 by jdu              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_wall(t_game *game, int x)
{
	...
	{
		tex_y = (int)game->wall_params.tex_pos \
			% game->wall_params.tex->height;
		if (tex_y < 0)
			tex_y += game->wall_params.tex->height;
		game->wall_params.tex_pos += game->wall_params.step;
		pixel = game->wall_params.tex->data \
			+ (tex_y * game->wall_params.tex->size_line \
			+ game->wall_params.tex_x \
			* (game->wall_params.tex->bpp / 8));
		color = *(int *)pixel;
